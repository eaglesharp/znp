    ...
    <div class="col-md-8 col-lg-8 col-xl-8">
      <div class="card rounded-3" style="background-color: #f6faff;">
        <div class="card-body p-4">
          <form method="post" action="{{ route('employer.submit.buy.interview') }}">
              <div class="d-sm-flex justify-content-between align-items-center border-bottom pb-4 mb-4">
                  
                <input type="hidden" name="amount" id="total_amount_val" value="{{ $total_amount }}">
                <input type="hidden" name="video_interview_check" id="video_interview_check" value="0">
