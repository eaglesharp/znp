                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-8 col-lg-8 col-xl-8">
                        <a href="{{ url('/employer-dashboard') }}">
                            <p style="color:red;">
                                @if ($employer->kyc_verified == 0)
                                    Please submit KYC documents to purchase the resumes. Please click here to submit documents.
                        ...
                        <div class="card rounded-3" style="background-color: #f6faff;">
                            <div class="card-body p-4">
                                <form method="post" action="{{ route('employer.submit.buy.cv') }}">
                                    <div
                                        class="d-sm-flex justify-content-between align-items-center border-bottom pb-4 mb-4">

                                        <input type="hidden" name="amount" id="total_amount_val"
                                            value="{{ $total_amount }}">
                                        <input type="hidden" name="video_interview_check" id="video_interview_check"
                                            value="0">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            ...
                                            <span class="h2 mx-1 mb-0" id="total-amount">{{ $total_amount ?? '' }}</span>
                                        </div>
                                    </div>
                    ...
                    @if ($user->recorded_video)
                        <div class="col-md-4 col-lg-4 col-xl-4">
                            <div class="card rounded-3" style="background-color: #e0dfdf;">
                                <div class="card-body p-4">
                                    <h5>Add On:</h5>
                                    <div class="d-flex justify-content-between align-items-baseline">
                                        <label> Buy Video Interview @ INR 1000</label>
                                        <span></span><input type="checkbox" class="form-control" placeholder=""
                                            style="width: 20px;height: 30px;" id="video_interview" value=""
        ...
        @push('scripts')
            <script>
                ...
                $(document).ready(function() {
                    ...
                    var totalAmount = parseInt("{{ 200 ?? '0' }}");

                    // Update the total amount when the checkbox is checked/unchecked
                    $("#video_interview").change(function() {
                        if ($(this).is(":checked")) {
                            // Checkbox is checked, add $100
                            totalAmount += 1000;
                            checked = 1
                        } else {
                            // Checkbox is unchecked, subtract $100
                            totalAmount -= 1000;
                            checked = 0;
                        }
                        ...
                        $("#total_amount_val").val($totalAmount);
                        $("#video_interview_check").val(checked);
                    });
                });
            </script>
        @endpush
