    ...
    <div class="container">
        ...
        <div class="col-md-12 col-lg-8 m-auto py-5">
            ...
            <div class="box py-4 rounded">
                ...
                <h5 class="sign_head text-center pt-3 mb-3">Clone a <span class=" sign_color">Job</span></h5>


                <form class="px-3 px-sm-5 priceform row"  method="POST" id="updatejob"  action="{{ route('clone.front.job',$job->id) }}">
             ...
             @csrf
                    ...
                    <div class="col-lg-6">
                       ...
                       @endphp
                        ...
                        <select id="inputState" class="w-100 py-2 px-3 signin_input rounded modeofwork" name="work_mode" @if($mode == "Remote/WFH") style="display:none;" @endif>
