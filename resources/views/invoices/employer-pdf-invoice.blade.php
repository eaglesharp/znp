 ...
 <div class="book">
	...
	<tr>
		...
		<td style="padding-bottom:40px;padding-top:70px;text-align:center!important;margin:auto;" colspan="3" >
			...
			<img src="{{ asset('asset/images/logo.png') }}" style="text-align:center;" >
            ...
            <table style="font-family:sans-serif;font-size:17px;padding:0;margin:auto;border: 1px solid black !important;" cellspacing="0">

                  <tr>

                    <th class="head" style="border:1px solid black;vertical-align: baseline;">Customer</th>

                    <th class="head" style="border:1px solid black">Invoice Details</th> 

                    <th class="head" style="border:1px solid black">Billing Office</th>

                  </tr>

                  <tr>

                    <td style="width:30%;border:1px solid black;vertical-align: baseline;" class="customer" >

                        <p><b>Bill-to/Sell-to Customer</b> </p>

                        <p><b>Name :</b> {{ $name }}</p>

                        <p><b>Address :</b> {{ $location }}</p>

                        <p><b>GSTN No :</b>{{ $gstin ?? '  -' }}</p>

                    </td>

                    <td style="display: contents;width:30%;border:1px solid black;vertical-align: baseline;" class="invoice">

                        <p><b>Invoice No.:</b>{{ $invoice_no }}</p>

                        <p><b>Invoice Date:</b> {{ \Carbon\Carbon::now()->format('d/m/Y') }}</p>

                    </td>

                    <td style="width:30%;border:1px solid black" class="billing">

                    <div class="bill" style="margin-bottom: 20px;/* padding-top: 0px; */">

                        <p><b>ZeroNoticePeriod</b></p>
...
# 07/03, 15/1, Second Floor, 18th

Main Road, Jayanagar 9th Block,
...
<p><b>GSTIN No: 29ALYPP0544M1Z7</b><p>
                ...
                <table style="width:100%" class="test1">
  ...
  <tr>
    ...
    <td>{{ $plan }} @if ($user_id) ({{ $user_id }}) @endif </td>
...
<ul type="none">
    ...
    <li>*Please note that the CV can be accessed immediately and is valid for a month with an option to email them 5 times.</li>

    <li>*This invoice is recognized subject to realization of Payment.</li>

    <li>*All cheques / DD should be made in favor of 'ZeroNoticePeriod' Payable in India</li>

    <li>*All disputes subject to Bangalore Jurisdiction only.</li>

    <li>*Whether Tax is payable on reverse charge: No. </li>
...
<table style="width:100%;" class="test">
  ...
  <tr  style="background-color:lightgrey">
    ...
    <th  colspan="4" style="text-align:left">BANK ACCOUNT DETAILS</th>
...
<!--            {{-- <td align="right" style="border: solid 1px #000 "><p style="margin: 0px;">1</p></td> --}}-->
