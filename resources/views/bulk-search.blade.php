...
@endphp
     ...
     <div class="boxing @if($emailed->emailed == 1) boxing stick_label_email @endif rounded px-4" id="checkbox_list">
         ...
         <div class="col-12 pt-3">
                  ...
                  <ul class="list-inline mb-1">
                   ...
                   <li class="list-inline-item font_color">
                     ...
                     <span class="sign_head"><h4 class="mb-0">{{ $user->first_name }}</h4></span>
             ...
             <li class="list-inline-item">
                 ...
                 <a href="tel: +91 {{ $user->phone }}" class="contact_phone">

                     <i class="fa fa-phone text-primary pr-2" aria-hidden="true"></i>+91 {{ $user->phone }}
