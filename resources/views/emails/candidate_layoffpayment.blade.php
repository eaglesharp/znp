                    ...
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:10px; text-align: left;">
                                    ...
                                    <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">Thank You for choosing to feature your resume as a “Layoff CV”.</p>                  
...
<td style="padding: 15px;">"Layoff CV" Feature</td>
...
<td style="padding-left: 30px;">499.00</td>
...
<td style="padding-left: 30px;">{{ $total_amount}}</td>
                                    ...
                                    <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left;color: black;margin-top: 30px;"><b>Please Note:</b> Your resume will be marked and shown to Recruiters as a “Layoff CV” denoting your last separation as caused by Layoff from your latest employer. This change will happen within 24 hours. Please note, marking your resume as a “Layoff CV” will help Recruiters distinguish your resume basis your latest employment status. </p>   	
