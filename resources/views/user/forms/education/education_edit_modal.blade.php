        ...
        <div class="modal-dialog">
            <div class="modal-content  mx-auto">
                ...
                <div class="modal-header pb-0">
                    <h4 class="modal-title sign_head">Edit Education</h4>
                ...
                @include('user.forms.education.education_edit_form')
                ...
                <div class="modal-footer">
                    <div class="col-12 text-right">
                        ...
                        <button type="button" class="signin_button  px-3 py-1 rounded"
                            data-toggle="modal" data-target="#create" onclick="updateeducation();">Save</button>
                    </div>
                </div>
            </div>
        </div>
