        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" id="previous_front_start1"
                    ...
                    class="datepicker w-100 signup_input rounded px-3 py-2 sign_fontsize" name="previous_start_date" value="{{ old('previous_start_date', (isset($user->getprofileJobCity()->previous_start_date))? $user->getprofileJobCity()->previous_start_date:'') }}"
            ...
            <div class="col-lg-6">
                ...
                <input type="text"  id="previous_front_end1" class="datepicker w-100 signup_input rounded px-3 py-2  sign_fontsize" name="previous_till_date" value="{{ old('previous_till_date', (isset($user->getprofileJobCity()->previous_till_date))? $user->getprofileJobCity()->previous_till_date:'') }}"
