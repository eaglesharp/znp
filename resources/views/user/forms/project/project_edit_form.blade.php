   ...
   <form class="form" id="edit_front_profile_project" method="PUT" action="{{ route('update.front.profile.projects', [$user->id]) }}">{{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <input type="text" name="name" class="w-100 signup_input rounded px-3 py-2" requried
                  ...
                  <input type="hidden" name="project_id" value="{{(isset($profileProject)? $profileProject->id:'')}}">
            ...
            <div class="col-lg-6">
                <label class="mb-2 pt-3 sign_fontsize">Duration of the Project<span
                        ...
                        {!! Form::select('duration', ['' => 'Select Duration']+MiscHelper::getprofilemonths1(), $project_duration , array('class'=>'w-100 pl-3 pr-4 py-2 form_control-arrow sign_fontsize  newduration1 signup_input rounded', 'id'=>'duration ')) !!}
            ...
            <div class="col-lg-6">
                <label class="mb-2 pt-3 sign_fontsize">Project Type<span
                        ...
                        ?>
                        {!! Form::select('project_type', ['' => 'Select Type']+MiscHelper::getprojecttype(), $project_type, array('class'=>'w-100 pl-3 pr-4 py-2 form_control-arrow sign_fontsize newprojects  signup_input rounded', 'id'=>'project_type1')) !!}
