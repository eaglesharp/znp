<form class="form" id="edit_certificate" method="POST" action="{{ route('update.front.certificate', [$user->id]) }}">{{csrf_field()}}
    <div class="row">
        <div class="col-lg-12">
            <label class="mb-2 pt-3 sign_fontsize">Certification Name<span
                    class="text-danger px-1">*</span></label>
            <input type="text"  name="certificate_name" class="w-100 signup_input rounded px-3 py-2" value="{{(isset($certificate) ? $certificate->certificate_name :'')}}" requried
                placeholder="Please Enter Your Certification Name"> 
                <input type="hidden" name="certificate_id" value="{{(isset($certificate) ? $certificate->id :'')}}">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <input type="text" name="certificate_agency"
                ...
                placeholder="Please Mention Your Certification Agency/School" value="{{(isset($certificate) ? $certificate->certificate_agency:'')}}">
