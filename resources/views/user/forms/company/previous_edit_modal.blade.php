        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content  mx-auto">
                ...
                <div class="modal-header pb-0">
                    ...
                    <h4 class="modal-title sign_head">Edit Previous Company</h4>
   ...
   @include('user.forms.company.previous_edit_form') 
   
   
   <p id="success_id10"  class="p-success px-0"></p>
   ...
   <div class="modal-footer">
       ...
       <div class="col-12 text-right">
           ...
           <button type="submit" class="signin_button  px-3 py-1 rounded"
               ...
               data-toggle="modal" data-target="#create" onclick="updatepreviouscompanyForm();">Save</button>
