        ...
        <div class="row pt-3" >
            ...
            <div class="col-lg-6">
                ...
                <input type="text" name="from_time"
                    ...
                    class="w-100 signup_input rounded px-3 py-2 sign_fontsize timepicker"  id="input_from">
             ...
             <div class="col-lg-6">
                ...
                <input type="text" name="to_time"
                    class="w-100 signup_input rounded px-3 py-2 sign_fontsize timepicker" id="input_to">
