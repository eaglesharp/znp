    ...
    <form class="form" id="edit_interview" method="POST" action="{{ route('update.video.interview',$user->id) }}">
      ...
      <div class="row pt-3" >
          <div class="col-lg-6">
              ...
              <input type="text" name="date"
                  ...
                  class="w-100 signup_input rounded px-3 py-2 sign_fontsize date-picker" id="date" >
          ...
          <div class="col-lg-6">
              ...
              <input type="text" name="from_time"
                  ...
                  class="w-100 signup_input rounded px-3 py-2 sign_fontsize timepicker"  id="edit_input_from">
           ...
           <div class="col-lg-6">
              ...
              <input type="text" name="to_time"
                  ...
                  class="w-100 signup_input rounded px-3 py-2 sign_fontsize timepicker" id="edit_input_to">
  ...
  <p id="success_id4" class="p-success px-0"></p>
  <!-- footer -->
  ...
  <div class="modal-footer">
      ...
      <div class="col-12 text-right">
          ...
          <button type="submit" class="signin_button  px-3 py-1 rounded" data-toggle="modal" data-target="#create"
              onclick="updateVideoInterviewForm();">Save</button>
