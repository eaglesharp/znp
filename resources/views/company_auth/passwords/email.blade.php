  ...
  <div class="pw-container">
    ...
    <div class="pw-right">
      ...
      @if (session('status'))
        ...
        <a href="{{ route('company.login') }}" class="pw-btn" style="display:block;text-align:center;text-decoration:none;">Back to Sign In</a>
      ...
      @else
        ...
        <a href="{{ url('employer-login') }}" class="pw-back">
          <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="pw-container">
    ...
    <div class="pw-right">
      ...
      @else
        ...
        <a href="{{ route('company.login') }}" class="pw-back">
          <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/>
          </svg>
          Back to Sign In
