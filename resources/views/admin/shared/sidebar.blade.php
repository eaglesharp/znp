...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
        ...
        {{-- @include('admin/shared/side_bars/employer') --}}
        ...
        {{--  @include('admin/shared/side_bars/education')  --}}
        ...
        @if (APAuthHelp::check(['SUP_ADM']))
            ...
            @include('admin/shared/side_bars/admin_user')
            <!--@include('admin/shared/side_bars/site_setting')-->
            <!--@include('admin/shared/side_bars/location')  -->
            @include('admin/shared/side_bars/counter')
            @include('admin/shared/side_bars/employer_activities')
