    ...
    <div class="form-body">
        ...
        <div class="form-group" id="div_year_of_passing1">
            ...
            <div class="form-group" id="div_organization">
                ...
                {!! Form::select('organization', [''=>'Select University / College']+MiscHelper::getuniversity(), $organization, array('class'=>'form-control', 'id'=>'organization')) !!}
        ...
        <div class="form-group" id="grade_achieved">
          ...
          <div class="row" id="achiveGradehide1" style="display:none">
            <div class="col-lg-12">
                ...
                <input type="text" name="grade_achieved1" value=""
