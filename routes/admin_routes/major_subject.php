...
Route::get('education', array_merge(['uses' => 'Admin\MajorSubjectController@indexEducations'], $all_users))->name('create.education');
Route::post('store-education', array_merge(['uses' => 'Admin\MajorSubjectController@storeEducation'], $all_users))->name('store.education');

Route::get('course', array_merge(['uses' => 'Admin\MajorSubjectController@indexCourse'], $all_users))->name('create.course');
Route::post('store-course', array_merge(['uses' => 'Admin\MajorSubjectController@storeCourse'], $all_users))->name('store.course');

Route::get('specs', array_merge(['uses' => 'Admin\MajorSubjectController@indexSpecs'], $all_users))->name('create.specs');
Route::post('store-specs', array_merge(['uses' => 'Admin\MajorSubjectController@storeSpecs'], $all_users))->name('store.specs');