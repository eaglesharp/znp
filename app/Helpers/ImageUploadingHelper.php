...

{
    ...
    public static function print_file($doc_path, $doc_title, $alt_title_txt = '')
...

    {
        ...
        if (!empty($doc_path) && file_exists(ImageUploadingHelper::real_public_path() . $doc_path)) {
            ...
            return '<a target="_blank" href="' . ImageUploadingHelper::public_path() . $doc_path . '" ' . ' alt="' . $alt_title_txt . '" title="' . $alt_title_txt . '">' . $doc_title . '</a>';
