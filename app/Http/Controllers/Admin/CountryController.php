...
class CountryController extends Controller
{
    ...
    public function indexcategoryLocations(Request $request)
    {
         return view('admin.location.category');
    }
     public function createcategoryLocations(Request $request)
    {
        $request->validate([
        ...
        $category = LocationCategory::where('id',$request->id)->first();
    ...
    public function createlocation(Request $request)
    {
        ...
        if($location)
        {
        $location->category_id = $request->input('category');
    ...
    public function editcategorylocation ($id)
    {
       $cate = LocationCategory::findOrFail($id);
       return view('admin.location.category',compact('cate'));
    }

    public function deletecategorylocation($id)
    {
        $location = LocationCategory::where('id',$id)->delete();
