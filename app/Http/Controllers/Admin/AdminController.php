...
$password = $request->password;
        ...
        Mail::send('admin.admin.emails.new_admin_user_created', ['user' => $user,'password'=>$password], function ($msg) use ($user) {
            $msg->from('info@zeronoticeperiod.com');
            $msg->to($user->email, $user->name)->subject('Account Created ' . config('app.name') . ' admin panel.');
        });
        /*         * ******************** */
