...
class MajorSubjectController extends Controller
{
    ...
    public function indexEducations()
    {
    
        return view('admin.education_type.education');
    }
    ...
    // return dd($education);
        return view('admin.education_type.course',compact('education'));
    ...
    $course=new Course();
    $course->education_id=$request->education_id;
    $course->course=$request->course;
    $course->save();
    return redirect()->back()->with('success','successfully added');
    }
    
    public function indexSpecs()
    {
    
    $courses=Course::all();
    return view('admin.education_type.specs',compact('courses'));
    
    }
    public function storeSpecs(Request $request)
    {
    
    $specs_data=new Specs();
    $specs_data->course_id='51';
    $specs_data->specs=$request->specs;
    $specs_data->save();
    return redirect()->back()->with('success','Successfully Added');
