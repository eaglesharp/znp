...

{
...

    {
        ...
        $profileProject->role_in_project = $request->input('role_in_project');

        $profileProject->client = $request->input('client');

        $profileProject->domain = $request->input('domain');

        $profileProject->duration = $request->input('duration');

        $profileProject->project_type = $request->input('project_type');

        $profileProject->tech_used = $request->input('tech_used');
    ...
    public function updateFrontProfileProject(ProfileProjectFormRequest $request, $id)

    {



        $profileProject = ProfileProject::find($request->project_id);

        $profileProject = $this->assignProjectValues($profileProject, $request, $id);
